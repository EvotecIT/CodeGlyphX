...
Updated: 2026-01-30 09:35:57 UTC
Framework: net8.0
Configuration: Release
Artifacts: /mnt/c/Support/GitHub/CodeMatrix/Build/BenchmarkResults/linux-20260130-103211
### How to read
- Mean: average time per operation. Lower is better.
- Allocated: managed memory allocated per operation. Lower is better.
- CodeGlyphX vs Fastest: CodeGlyphX mean divided by the fastest mean for that scenario. If CodeGlyphX is fastest, the text shows the lead vs the runner-up; otherwise it shows the lag vs the fastest vendor.
...
| Benchmark | Scenario | Fastest | CodeGlyphX (Mean / Alloc) | ZXing.Net (Mean / Alloc) | QRCoder (Mean / Alloc) | Barcoder (Mean / Alloc) | CodeGlyphX vs Fastest | CodeGlyphX Alloc vs Fastest | Rating |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Aztec (Encode) | Aztec PNG | CodeGlyphX 216.3 μs | 216.3 μs<br>61.39 KB | 1,519.3 μs<br>61.42 KB<br>Δ 7.02 x / 1 x |  | 6,825.7 μs<br>642.46 KB<br>Δ 31.56 x / 10.47 x | 1 x (fastest, lead 7.02 x vs ZXing.Net) | 1 x | good |
| Code 128 (Encode) | Code128 PNG | CodeGlyphX 133.4 μs | 133.4 μs<br>14.48 KB | 1,569.4 μs<br>15.74 KB<br>Δ 11.76 x / 1.09 x |  | 53,033.3 μs<br>2035.13 KB<br>Δ 397.55 x / 140.55 x | 1 x (fastest, lead 11.76 x vs ZXing.Net) | 1 x | good |
| Code 39 (Encode) | Code39 PNG | CodeGlyphX 151.6 μs | 151.6 μs<br>10.07 KB | 1,383.8 μs<br>12.28 KB<br>Δ 9.13 x / 1.22 x |  | 38,828.4 μs<br>1448.58 KB<br>Δ 256.12 x / 143.85 x | 1 x (fastest, lead 9.13 x vs ZXing.Net) | 1 x | good |
| Code 93 (Encode) | Code93 PNG | CodeGlyphX 189.9 μs | 189.9 μs<br>8.19 KB | 1,129.0 μs<br>11.7 KB<br>Δ 5.95 x / 1.43 x |  | 25,633.9 μs<br>957.3 KB<br>Δ 134.99 x / 116.89 x | 1 x (fastest, lead 5.95 x vs ZXing.Net) | 1 x | good |
| Data Matrix (Encode) | Data Matrix PNG (medium) | CodeGlyphX 207.7 μs | 207.7 μs<br>15.58 KB | 1,595.3 μs<br>22.31 KB<br>Δ 7.68 x / 1.43 x |  | 7,793.7 μs<br>644.93 KB<br>Δ 37.52 x / 41.39 x | 1 x (fastest, lead 7.68 x vs ZXing.Net) | 1 x | good |
| EAN-13 (Encode) | EAN-13 PNG | CodeGlyphX 139.0 μs | 139.0 μs<br>6.8 KB | 1,105.7 μs<br>11.68 KB<br>Δ 7.95 x / 1.72 x |  | 22,834.6 μs<br>850.8 KB<br>Δ 164.28 x / 125.12 x | 1 x (fastest, lead 7.95 x vs ZXing.Net) | 1 x | good |
| PDF417 (Encode) | PDF417 PNG | CodeGlyphX 1.025 ms | 1.025 ms<br>49.95 KB | 5.639 ms<br>207.63 KB<br>Δ 5.5 x / 4.16 x |  | 50.328 ms<br>5003.8 KB<br>Δ 49.1 x / 100.18 x | 1 x (fastest, lead 5.5 x vs ZXing.Net) | 1 x | good |
| QR (Encode) | QR PNG (medium) | CodeGlyphX 578.6 μs | 578.6 μs<br>14.88 KB | 3,515.6 μs<br>79.41 KB<br>Δ 6.08 x / 5.34 x | 1,055.0 μs<br>7.28 KB<br>Δ 1.82 x / 0.49 x | 15,654.6 μs<br>1547.27 KB<br>Δ 27.06 x / 103.98 x | 1 x (fastest, lead 1.82 x vs QRCoder) | 1 x | good |
| QR Decode (Clean) | QR Decode (clean) | CodeGlyphX 1.120 ms | 1.120 ms<br>3.91 KB | 1.863 ms<br>127.67 KB<br>Δ 1.66 x / 32.65 x |  |  | 1 x (fastest, lead 1.66 x vs ZXing.Net) | 1 x | good |
| QR Decode (Noisy) | QR Decode (noisy) | ZXing.Net 3.381 ms | 42.635 ms<br>160.77 KB | 3.381 ms<br>706.89 KB<br>Δ 0.08 x / 4.4 x |  |  | 12.61 x (lag vs ZXing.Net) | 0.23 x | bad |
| QR Decode (Stress) | QR Decode (fancy) | CodeGlyphX 396.8 μs | 396.8 μs<br>2.68 KB | 626.9 μs<br>63.25 KB<br>Δ 1.58 x / 23.6 x |  |  | 1 x (fastest, lead 1.58 x vs ZXing.Net) | 1 x | good |
| QR Decode (Stress) | QR Decode (no quiet zone) | ZXing.Net 1,020.6 μs | 10,629.6 μs<br>45.09 KB | 1,020.6 μs<br>65.78 KB<br>Δ 0.1 x / 1.46 x |  |  | 10.42 x (lag vs ZXing.Net) | 0.69 x | bad |
| QR Decode (Stress) | QR Decode (resampled) | CodeGlyphX 545.8 μs | 545.8 μs<br>1.88 KB | 589.7 μs<br>135.23 KB<br>Δ 1.08 x / 71.93 x |  |  | 1 x (fastest, lead 1.08 x vs ZXing.Net) | 1 x | good |
| UPC-A (Encode) | UPC-A PNG | CodeGlyphX 163.9 μs | 163.9 μs<br>7.11 KB | 998.9 μs<br>11.75 KB<br>Δ 6.09 x / 1.65 x |  | 19,815.3 μs<br>765.86 KB<br>Δ 120.9 x / 107.72 x | 1 x (fastest, lead 6.09 x vs ZXing.Net) | 1 x | good |
...
| Scenario | Mean | Allocated |
| --- | --- | --- |
| Code 128 PNG | 148.33 μs | 14.57 KB |
| Code 128 SVG | 32.09 μs | 20.56 KB |
| EAN PNG | 146.19 μs | 6.89 KB |
| Code 39 PNG | 155.90 μs | 10.16 KB |
| Code 93 PNG | 173.13 μs | 8.27 KB |
| UPC-A PNG | 190.57 μs | 7.2 KB |

#### 2D Matrix Codes (Encode)

| Scenario | Mean | Allocated |
| --- | --- | --- |
| Data Matrix PNG (medium) | 207.79 μs | 10.23 KB |
| Data Matrix PNG (long) | 385.24 μs | 20.4 KB |
| Data Matrix SVG | 57.21 μs | 14.38 KB |
| PDF417 PNG | 1,106.59 μs | 50.05 KB |
| PDF417 SVG | 3,022.20 μs | 74.66 KB |
| Aztec PNG | 231.49 μs | 61.45 KB |
| Aztec SVG | 104.77 μs | 61.47 KB |

#### QR (Encode)

| Scenario | Mean | Allocated |
| --- | --- | --- |
| QR PNG (short text) | 470.3 μs | 9.77 KB |
| QR PNG (medium text) | 622.9 μs | 14.88 KB |
| QR PNG (long text) | 2,383.3 μs | 37.32 KB |
| QR SVG (medium text) | 619.9 μs | 21.83 KB |
| QR PNG High Error Correction | 891.1 μs | 21.27 KB |
| QR PNG (medium text, logo) | 4,601.9 μs | 1099.84 KB |
| QR PNG (medium text, fancy) | 2,045.9 μs | 388.58 KB |
| QR HTML (medium text) | 630.6 μs | 169.2 KB |

#### QR (Decode)

| Scenario | Mean | Allocated |
| --- | --- | --- |
| QR Decode (clean, fast) | 1,099.3 μs | 3.91 KB |
| QR Decode (clean, balanced) | 1,095.7 μs | 3.91 KB |
| QR Decode (clean, robust) | 111,299.6 μs | 737.06 KB |
| QR Decode (noisy, robust) | 42,781.6 μs | 160.77 KB |
| QR Decode (screenshot, balanced) | 5,685.6 μs | 3.91 KB |
| QR Decode (antialias, robust) | 1,641.4 μs | 173.73 KB |
| QR Decode (fancy, robust) | 480.8 μs | 2.49 KB |
| QR Decode (resampled, balanced) | 591.7 μs | 1.88 KB |
| QR Decode (no quiet zone, robust) | 109,994.2 μs | 787.41 KB |

#### QrPipelineBenchmarks

| Scenario | Mean | Allocated |
| --- | --- | --- |
| QR Encode (short text) | 298.51 μs | 936 B |
| QR Encode (medium text) | 674.53 μs | 1288 B |
| QR Encode (long text) | 1,361.56 μs | 2752 B |
| QR Render PNG (short, pre-encoded) | 154.00 μs | 8568 B |
| QR Render PNG (medium, pre-encoded) | 51.63 μs | 13448 B |
| QR Render PNG (long, pre-encoded) | 731.65 μs | 34968 B |
| QR Render Pixels (short, pre-encoded) | 22.39 μs | 121128 B |
| QR Render Pixels (medium, pre-encoded) | 37.54 μs | 197160 B |
| QR Render Pixels (long, pre-encoded) | 821.40 μs | 535848 B |
...
| Scenario | CodeGlyphX (Mean / Alloc) | ZXing.Net (Mean / Alloc) | QRCoder (Mean / Alloc) | Barcoder (Mean / Alloc) |
| --- | --- | --- | --- | --- |
| Aztec PNG | 216.3 μs<br>61.39 KB | 1,519.3 μs<br>61.42 KB<br>Δ 7.02 x / 1 x |  | 6,825.7 μs<br>642.46 KB<br>Δ 31.56 x / 10.47 x |

#### Code 128 (Encode)

| Scenario | CodeGlyphX (Mean / Alloc) | ZXing.Net (Mean / Alloc) | QRCoder (Mean / Alloc) | Barcoder (Mean / Alloc) |
| --- | --- | --- | --- | --- |
| Code128 PNG | 133.4 μs<br>14.48 KB | 1,569.4 μs<br>15.74 KB<br>Δ 11.76 x / 1.09 x |  | 53,033.3 μs<br>2035.13 KB<br>Δ 397.55 x / 140.55 x |

#### Code 39 (Encode)

| Scenario | CodeGlyphX (Mean / Alloc) | ZXing.Net (Mean / Alloc) | QRCoder (Mean / Alloc) | Barcoder (Mean / Alloc) |
| --- | --- | --- | --- | --- |
| Code39 PNG | 151.6 μs<br>10.07 KB | 1,383.8 μs<br>12.28 KB<br>Δ 9.13 x / 1.22 x |  | 38,828.4 μs<br>1448.58 KB<br>Δ 256.12 x / 143.85 x |

#### Code 93 (Encode)

| Scenario | CodeGlyphX (Mean / Alloc) | ZXing.Net (Mean / Alloc) | QRCoder (Mean / Alloc) | Barcoder (Mean / Alloc) |
| --- | --- | --- | --- | --- |
| Code93 PNG | 189.9 μs<br>8.19 KB | 1,129.0 μs<br>11.7 KB<br>Δ 5.95 x / 1.43 x |  | 25,633.9 μs<br>957.3 KB<br>Δ 134.99 x / 116.89 x |

#### Data Matrix (Encode)

| Scenario | CodeGlyphX (Mean / Alloc) | ZXing.Net (Mean / Alloc) | QRCoder (Mean / Alloc) | Barcoder (Mean / Alloc) |
| --- | --- | --- | --- | --- |
| Data Matrix PNG (medium) | 207.7 μs<br>15.58 KB | 1,595.3 μs<br>22.31 KB<br>Δ 7.68 x / 1.43 x |  | 7,793.7 μs<br>644.93 KB<br>Δ 37.52 x / 41.39 x |

#### EAN-13 (Encode)

| Scenario | CodeGlyphX (Mean / Alloc) | ZXing.Net (Mean / Alloc) | QRCoder (Mean / Alloc) | Barcoder (Mean / Alloc) |
| --- | --- | --- | --- | --- |
| EAN-13 PNG | 139.0 μs<br>6.8 KB | 1,105.7 μs<br>11.68 KB<br>Δ 7.95 x / 1.72 x |  | 22,834.6 μs<br>850.8 KB<br>Δ 164.28 x / 125.12 x |

#### PDF417 (Encode)

| Scenario | CodeGlyphX (Mean / Alloc) | ZXing.Net (Mean / Alloc) | QRCoder (Mean / Alloc) | Barcoder (Mean / Alloc) |
| --- | --- | --- | --- | --- |
| PDF417 PNG | 1.025 ms<br>49.95 KB | 5.639 ms<br>207.63 KB<br>Δ 5.5 x / 4.16 x |  | 50.328 ms<br>5003.8 KB<br>Δ 49.1 x / 100.18 x |

#### QR (Encode)

| Scenario | CodeGlyphX (Mean / Alloc) | ZXing.Net (Mean / Alloc) | QRCoder (Mean / Alloc) | Barcoder (Mean / Alloc) |
| --- | --- | --- | --- | --- |
| QR PNG (medium) | 578.6 μs<br>14.88 KB | 3,515.6 μs<br>79.41 KB<br>Δ 6.08 x / 5.34 x | 1,055.0 μs<br>7.28 KB<br>Δ 1.82 x / 0.49 x | 15,654.6 μs<br>1547.27 KB<br>Δ 27.06 x / 103.98 x |

#### QR Decode (Clean)

| Scenario | CodeGlyphX (Mean / Alloc) | ZXing.Net (Mean / Alloc) | QRCoder (Mean / Alloc) | Barcoder (Mean / Alloc) |
| --- | --- | --- | --- | --- |
| QR Decode (clean) | 1.120 ms<br>3.91 KB | 1.863 ms<br>127.67 KB<br>Δ 1.66 x / 32.65 x |  |  |

#### QR Decode (Noisy)

| Scenario | CodeGlyphX (Mean / Alloc) | ZXing.Net (Mean / Alloc) | QRCoder (Mean / Alloc) | Barcoder (Mean / Alloc) |
| --- | --- | --- | --- | --- |
| QR Decode (noisy) | 42.635 ms<br>160.77 KB | 3.381 ms<br>706.89 KB<br>Δ 0.08 x / 4.4 x |  |  |

#### QR Decode (Stress)

| Scenario | CodeGlyphX (Mean / Alloc) | ZXing.Net (Mean / Alloc) | QRCoder (Mean / Alloc) | Barcoder (Mean / Alloc) |
| --- | --- | --- | --- | --- |
| QR Decode (fancy) | 396.8 μs<br>2.68 KB | 626.9 μs<br>63.25 KB<br>Δ 1.58 x / 23.6 x |  |  |
| QR Decode (no quiet zone) | 10,629.6 μs<br>45.09 KB | 1,020.6 μs<br>65.78 KB<br>Δ 0.1 x / 1.46 x |  |  |
| QR Decode (resampled) | 545.8 μs<br>1.88 KB | 589.7 μs<br>135.23 KB<br>Δ 1.08 x / 71.93 x |  |  |

#### UPC-A (Encode)

| Scenario | CodeGlyphX (Mean / Alloc) | ZXing.Net (Mean / Alloc) | QRCoder (Mean / Alloc) | Barcoder (Mean / Alloc) |
| --- | --- | --- | --- | --- |
| UPC-A PNG | 163.9 μs<br>7.11 KB | 998.9 μs<br>11.75 KB<br>Δ 6.09 x / 1.65 x |  | 19,815.3 μs<br>765.86 KB<br>Δ 120.9 x / 107.72 x |
