...
Updated: 2026-01-24 10:19:00 UTC
Framework: net8.0
Configuration: Release
Artifacts: C:\Support\GitHub\CodeMatrix\Build\BenchmarkResults\windows-20260124-111753
### How to read
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Aztec (Encode) | Aztec PNG | CodeGlyphX 222.1 μs | 222.1 μs<br>61.34 KB | 1,533.6 μs<br>61.42 KB<br>Δ 6.9 x / 1 x |  | 7,519.3 μs<br>642.58 KB<br>Δ 33.86 x / 10.48 x | 1 x (fastest) | 1 x | good |
| Code 128 (Encode) | Code128 PNG | CodeGlyphX 173.3 μs | 173.3 μs<br>14.43 KB | 1,794.0 μs<br>15.74 KB<br>Δ 10.35 x / 1.09 x |  | 50,197.1 μs<br>2035.16 KB<br>Δ 289.65 x / 141.04 x | 1 x (fastest) | 1 x | good |
| Code 39 (Encode) | Code39 PNG | CodeGlyphX 172.6 μs | 172.6 μs<br>10.02 KB | 1,667.8 μs<br>12.28 KB<br>Δ 9.66 x / 1.23 x |  | 38,262.5 μs<br>1448.61 KB<br>Δ 221.68 x / 144.57 x | 1 x (fastest) | 1 x | good |
| Code 93 (Encode) | Code93 PNG | CodeGlyphX 159.2 μs | 159.2 μs<br>8.13 KB | 1,450.8 μs<br>11.7 KB<br>Δ 9.11 x / 1.44 x |  | 22,938.5 μs<br>957.41 KB<br>Δ 144.09 x / 117.76 x | 1 x (fastest) | 1 x | good |
| Data Matrix (Encode) | Data Matrix PNG (medium) | CodeGlyphX 226.8 μs | 226.8 μs<br>15.52 KB | 1,703.4 μs<br>22.31 KB<br>Δ 7.51 x / 1.44 x |  | 8,912.7 μs<br>645.05 KB<br>Δ 39.3 x / 41.56 x | 1 x (fastest) | 1 x | good |
| EAN-13 (Encode) | EAN-13 PNG | CodeGlyphX 199.0 μs | 199.0 μs<br>6.84 KB | 1,030.8 μs<br>11.68 KB<br>Δ 5.18 x / 1.71 x |  | 21,580.0 μs<br>850.67 KB<br>Δ 108.44 x / 124.37 x | 1 x (fastest) | 1 x | good |
| PDF417 (Encode) | PDF417 PNG | CodeGlyphX 1.150 ms | 1.150 ms<br>49.9 KB | 6.801 ms<br>207.63 KB<br>Δ 5.91 x / 4.16 x |  | 57.925 ms<br>5003.86 KB<br>Δ 50.37 x / 100.28 x | 1 x (fastest) | 1 x | good |
| QR (Encode) | QR PNG (medium) | CodeGlyphX 687.7 μs | 687.7 μs<br>14.19 KB | 4,108.0 μs<br>79.41 KB<br>Δ 5.97 x / 5.6 x | 971.9 μs<br>7.31 KB<br>Δ 1.41 x / 0.52 x | 14,996.5 μs<br>1547.36 KB<br>Δ 21.81 x / 109.05 x | 1 x (fastest) | 1 x | good |
| QR Decode (Clean) | QR Decode (clean) | ZXing.Net 1.993 ms | 1.998 ms<br>5.27 KB | 1.993 ms<br>127.67 KB<br>Δ 1 x / 24.23 x |  |  | 1 x | 0.04 x | good |
| QR Decode (Noisy) | QR Decode (noisy) | CodeGlyphX 4.189 ms | 4.189 ms<br>5.45 KB | 4.413 ms<br>706.89 KB<br>Δ 1.05 x / 129.7 x |  |  | 1 x (fastest) | 1 x | good |
| UPC-A (Encode) | UPC-A PNG | CodeGlyphX 167.1 μs | 167.1 μs<br>7.15 KB | 1,330.5 μs<br>11.75 KB<br>Δ 7.96 x / 1.64 x |  | 22,742.3 μs<br>765.73 KB<br>Δ 136.1 x / 107.1 x | 1 x (fastest) | 1 x | good |
