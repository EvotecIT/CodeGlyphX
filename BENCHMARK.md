...
Updated: 2026-01-23 21:23:16 UTC
Framework: net8.0
Configuration: Release
Artifacts: .\Build\BenchmarkResults\windows-20260123-204729
How to read:
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| QR Decode (Clean) | QR Decode (clean) | ZXing.Net 1.878 ms | 2.626 ms<br>5.27 KB | 1.878 ms<br>127.67 KB<br>Δ 0.72 x / 24.23 x |  |  | 1.4 x | 0.04 x | ok |
| QR Decode (Noisy) | QR Decode (noisy) | ZXing.Net 3.735 ms | 6.385 ms<br>5.45 KB | 3.735 ms<br>706.89 KB<br>Δ 0.58 x / 129.7 x |  |  | 1.71 x | 0.01 x | bad |
...
| --- | --- | --- |
| QR Decode (clean, fast) | 1,915.2 μs | 5.27 KB |
| QR Decode (clean, balanced) | 1,755.2 μs | 5.27 KB |
| QR Decode (clean, robust) | 1,887.9 μs | 5.27 KB |
| QR Decode (noisy, robust) | 4,963.9 μs | 5.45 KB |
| QR Decode (screenshot, balanced) | 10,142.4 μs | 5.27 KB |
| QR Decode (antialias, robust) | 431.1 μs | 1.32 KB |
...
| --- | --- | --- | --- | --- |
| QR Decode (clean) | 2.626 ms<br>5.27 KB | 1.878 ms<br>127.67 KB<br>Δ 0.72 x / 24.23 x |  |  |

#### QR Decode (Noisy)

| Scenario | CodeGlyphX (Mean / Alloc) | ZXing.Net (Mean / Alloc) | QRCoder (Mean / Alloc) | Barcoder (Mean / Alloc) |
| --- | --- | --- | --- | --- |
| QR Decode (noisy) | 6.385 ms<br>5.45 KB | 3.735 ms<br>706.89 KB<br>Δ 0.58 x / 129.7 x |  |  |
<!-- BENCHMARK:WINDOWS:QUICK:END -->

<!-- BENCHMARK:WINDOWS:FULL:START -->
## WINDOWS

Updated: 2026-01-23 21:23:33 UTC
Framework: net8.0
Configuration: Release
