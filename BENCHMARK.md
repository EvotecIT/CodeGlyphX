...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Aztec (Encode) | Aztec PNG | CodeGlyphX 324.2 μs | 1 x | 1 x | good | 324.2 μs | 452.22 KB |
| Code 128 (Encode) | Code128 PNG | CodeGlyphX 435.2 μs | 1 x | 1 x | good | 435.2 μs | 756.09 KB |
| Code 39 (Encode) | Code39 PNG | CodeGlyphX 288.3 μs | 1 x | 1 x | good | 288.3 μs | 414.38 KB |
| Code 93 (Encode) | Code93 PNG | CodeGlyphX 221.8 μs | 1 x | 1 x | good | 221.8 μs | 367.65 KB |
| Data Matrix (Encode) | Data Matrix PNG (medium) | CodeGlyphX 343.5 μs | 1 x | 1 x | good | 343.5 μs | 421.62 KB |
| EAN-13 (Encode) | EAN-13 PNG | CodeGlyphX 213.9 μs | 1 x | 1 x | good | 213.9 μs | 338.55 KB |
| PDF417 (Encode) | PDF417 PNG | CodeGlyphX 1.828 ms | 1 x | 1 x | good | 1.828 ms | 3154.45 KB |
| QR (Encode) | QR PNG (medium) | QRCoder 831.5 μs | 1.78 x | 114.57 x | bad | 1,476.0 μs | 837.5 KB |
| QR Decode (Clean) | QR Decode (clean) | ZXing.Net 1.672 ms | 1.41 x | 0.81 x | ok | 2.350 ms | 103.9 KB |
| QR Decode (Noisy) | QR Decode (noisy) | ZXing.Net 3.322 ms | 46.15 x | 12.03 x | bad | 153.310 ms | 8507.11 KB |
| UPC-A (Encode) | UPC-A PNG | CodeGlyphX 197.3 μs | 1 x | 1 x | good | 197.3 μs | 338.85 KB |
