...
- PDF decode is limited to embedded image-only JPEG/Flate/LZW (with ASCII85/ASCIIHex/RunLength wrappers), including inline images, Indexed color spaces, basic ICCBased/Separation/DeviceN alternates, SMask alpha, and color-key /Mask arrays. PS decode is not supported (rasterize first)
