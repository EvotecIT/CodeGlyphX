...
- PDF decode is limited to embedded image-only JPEG/Flate (with ASCII85/RunLength wrappers); inline images are not supported. PS decode is not supported (rasterize first)
