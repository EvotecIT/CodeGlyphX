...
- PDF decode is limited to embedded image-only JPEG/Flate (with ASCII85/RunLength wrappers), including inline images. PS decode is not supported (rasterize first)
