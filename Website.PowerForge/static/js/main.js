...
// Theme cycle (auto -> light -> dark) and mobile nav toggle for static pages
(() => {
    const cycleButton = document.querySelector('.theme-cycle-btn');
